...
\begin{figure}[htbp]
    ...
    \subfigure[3Dモデル]{
        \includegraphics[width=0.45\linewidth]{images/3D_model_1_1.png}
        \label{fig:3Dモデル1}
    }
    \caption{原案1}
    \label{figs:原案1}
...
\begin{figure}[htbp]
    \centering
    \subfigure[3Dモデル]{
        \includegraphics[width=0.45\linewidth]{images/3D_model_2_2.png}
        \label{fig:3Dモデル2}
    }
    \subfigure[円想者の舞台]{
        \includegraphics[width=0.45\linewidth]{images/base_bone_1.jpg}
        \label{fig:円想者}
    }
    \subfigure[ミニゲームについて]{
        \includegraphics[width=0.4\linewidth]{images/minigame.jpg}
        \label{fig:ミニゲーム}
    }
    \subfigure[意見・質問(1)]{
        \includegraphics[width=0.25\linewidth]{images/feedback_1.png}
        \label{fig:質問1}
    }
    \subfigure[意見・質問(2)]{
        \includegraphics[width=0.25\linewidth]{images/feedback_2.png}
        \label{fig:質問2}
    }
    \caption{原案2}
    \label{figs:原案2}
