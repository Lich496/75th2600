...
\begin{imageHere}{原案1}
    \includefig{0.45}{企画書}{fig:企画書}{presentation/original_plan.png}
    \includefig{0.45}{3Dモデル}{fig:3Dモデル1}{presentation/3D_model/3D_model_1_1.png}
\end{imageHere}
...
\begin{imageHere}{原案2-1}
    \begin{minipage}{0.5\linewidth}
        \centering
        \includefig{1}{3Dモデル}{fig:3Dモデル2}{presentation/3D_model/3D_model_2_2.png}
    \end{minipage}\hfill
    \begin{minipage}{0.4\linewidth}
        \centering
        \includefig{1}{円想者の舞台(1)}{fig:円想者1}{presentation/base_bone_1.jpg}
        \includefig{1}{円想者の舞台(2)}{fig:円想者2}{presentation/base_bone_2.jpg}
    \end{minipage}
\end{imageHere}

\begin{imageHere}{原案2-2}
    \includefig{0.45}{スライドの抜粋(1)}{fig:スライド1}{presentation/presentation2_1.png}
    \includefig{0.45}{スライドの抜粋(2)}{fig:スライド2}{presentation/presentation2_2.png}
    \includefig{0.35}{ミニゲームについて}{fig:ミニゲーム}{presentation/minigame.jpg}
    \includefig{0.25}{意見・質問(1)}{fig:質問1}{presentation/feedback_1.png}
    \includefig{0.25}{意見・質問(2)}{fig:質問2}{presentation/feedback_2.png}
    \includefig{0.45}{意見・質問への解答}{fig:質問3}{presentation/feedback_3.png}
\end{imageHere}
...
\begin{imageHere}{部屋の分割}
    \includegraphics[width=0.7\linewidth]{minigame/0.png}
\end{imageHere}

\section{ミニゲームプレゼン@Mar 22}
...
6案が出て、そのうち佐野案(\fullref{fig:佐野案})では紙で内装の模型(\fullref{fig:模型1},\fullref{fig:模型2})を作ってきてくれました。
実際に宇宙船が回転できるものだったので皆にイメージを持ってもらうためにも一役買い、最後までお世話になった模型になりました。
また、同案の内装のイメージはそのままの再現こそできなかったもの、ドアなどのデザイン・設計の目標となりました。

田中案(\fullref{fig:田中案})は最終的なストーリーのベースとなりました。
ただ、船外の装飾は時間的制約の関係で実現できず、窓も無くなっています。

\begin{imageHere}{ミニゲームプレゼン}
    \includefig[t]{0.45}{模型-全体像}{fig:模型1}{minigame/1.jpg}
    \vspace{-35mm}
    \includefig[c]{0.45}{模型-タラップ}{fig:模型2}{minigame/2.jpg}
    \includefig[b]{0.45}{内装イメージ(佐野案)}{fig:佐野案}{minigame/3.jpg}
    \includefig[b]{0.45}{船外を装飾する案(田中案)}{fig:田中案}{minigame/4.jpg}
\end{imageHere}
...
\begin{imageHere}{平面図}
    \includegraphics[width=0.45\linewidth]{plan/69138.jpg}
\end{imageHere}
