...
\begin{titlepage}
    ...
    %TITLE SECTION
    \hrulefill\\[0.4cm]
    { \huge \bfseries コズミックトラ\rotatebox[origin=c]{-60}{ベ}ル}\\[0.2cm]
    \hrulefill\\[1cm]
    ...
    %LOGO SECTION
    \includegraphics[width=0.3\linewidth]{logo_t.png}
...
\begin{imageHere}{設計概観}
    \includegraphics[width=0.5\linewidth]{plan_overview/1.png}
\end{imageHere}
